        ...
        <div class="row">
          ...
          <div class="col-lg-9">
          	<div class="row">
          		...
          		<div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate fadeInUp ftco-animated">
          		...
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-4 fadeInUp ftco-animated">
          			<h4 class="mb-4">Take A Tour</h4>
          			<div class="block-16">
		              <figure>
		                <img class="img-fluid" alt="Image placeholder" src="${pageContext.request.contextPath }/resources/user/images/hotel-6.jpg">
		                <a class="play-button popup-vimeo" href="https://vimeo.com/45830194"><span class="icon-play"></span></a>
		              </figure>
		            </div>
          		</div>
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-4 fadeInUp ftco-animated">
          			...
          			<div class="row">
          				<div class="col-md-4">
				    				<div class="destination">
				    					<a class="img img-2" style="background-image: url(${pageContext.request.contextPath }/resources/user/images/room-4.jpg);" href="hotel-single.html"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a class="img img-2" style="background-image: url(${pageContext.request.contextPath }/resources/user/images/room-5.jpg);" href="hotel-single.html"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="hotel-single.html">Hotel, Italy</a></h3>
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a class="img img-2" style="background-image: url(${pageContext.request.contextPath }/resources/user/images/room-6.jpg);" href="hotel-single.html"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="hotel-single.html">Hotel, Italy</a></h3>
          		...
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-5 fadeInUp ftco-animated">
          			<h4 class="mb-4">Related Hotels</h4>
          			<div class="row">
          				<div class="col-md-4">
				    				<div class="destination">
				    					<a class="img img-2" style="background-image: url(${pageContext.request.contextPath }/resources/user/images/hotel-1.jpg);" href="hotel-single.html"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="hotel-single.html">Hotel, Italy</a></h3>
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a class="img img-2" style="background-image: url(${pageContext.request.contextPath }/resources/user/images/hotel-2.jpg);" href="hotel-single.html"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="hotel-single.html">Hotel, Italy</a></h3>
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a class="img img-2" style="background-image: url(${pageContext.request.contextPath }/resources/user/images/hotel-3.jpg);" href="hotel-single.html"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="hotel-single.html">Hotel, Italy</a></h3>
