	...
	<div class="row">
		...
		<div class="col-11">
			...
			<s:form method="post" modelAttribute="saleModel"
				...
				action="${pageContext.request.contextPath }/employee/promotion/update/${id}">

				<h5>Code:</h5>
				<s:input path="code" style="width: 500px" value="${editSale.code }"/>
				<br>

				<h5>%Sale:</h5>
				<s:input path="sales" style="width: 500px" value="${editSale.sale }"/>
				<br>
