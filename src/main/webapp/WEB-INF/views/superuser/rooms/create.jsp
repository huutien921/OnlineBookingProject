...
<section class="content">
    ...
    <div class="alert alert-danger alert-dismissible">
			...
			<s:form role="form" modelAttribute="room" method="post"  enctype="multipart/form-data" action="${pageContext.request.contextPath}/superuser/myroom/create">

				<div class="form-group">
					<label>Name Room </label>  <p class="text-red"> <s:errors path="name" ></s:errors></p><s:input path="name" class="form-control"
						placeholder="Name ..." />
						
				</div>
				<div class="form-group"><label for="exampleInputFile">Avatar Room</label><br>
				<table>
				<tr>
				<td> 
				<c:if test="${room.srcIcon == null }">
				
					<img class="profile-user-img img-responsive img-rounded pull-left" src="${pageContext.request.contextPath }/resources/user/images/roomDefault.jpg" alt="room image" id="hotel_image">
			
				</c:if>
					<c:if test="${room.srcIcon != null }">
				<img class="profile-user-img img-responsive img-rounded pull-left" src="${pageContext.request.contextPath }/uploads/images/${room.image}" alt="room image" id="hotel_image">
				</c:if>
				</td>
					...
					<tr>
				<td>
						 <p class="text-red"> <s:errors path="srcIcon" ></s:errors></p>
                ...
                <s:select  class="form-control select2" style="width: 100%;" path="bedType" items="${beds }"  itemLabel="name" itemValue="id"></s:select>
              </div>
              	    <div class="form-group">
                <label>Room category</label>
           
                <s:select  class="form-control select2" style="width: 100%;" path="roomCategory" items="${categorys }"  itemLabel="name" itemValue="id"></s:select>
              </div>
              	    <div class="form-group">
                <label>Room type</label>
           
                <s:select  class="form-control select2" style="width: 100%;" path="roomType" items="${types }"  itemLabel="name" itemValue="id"></s:select>
              </div>
				<div class="form-group">
					<label>Price</label><p class="text-red"> <s:errors path="price" ></s:errors></p> <s:input  path="price" min="0"  type="number" class="form-control"
						placeholder="Price  ..."/>
				</div>
					<div class="form-group">
					<label>Amount Of Bed</label><p class="text-red"> <s:errors path="amountOfBed" ></s:errors></p> <s:input  path="amountOfBed" min="1" max="30"  type="number" class="form-control"
						placeholder="Amount Of Bed  ..."/>
				</div>
				<div class="form-group">
					<label>Capacity</label><p class="text-red"> <s:errors path="capacity" ></s:errors></p> <s:input  path="capacity" min="1" max="100"  type="number" class="form-control"
