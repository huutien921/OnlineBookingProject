...
<section class="content">
    ...
    <div class="alert alert-danger alert-dismissible">
                ...
                <h4><i class="icon fa fa-ban"></i> Add Room failed !</h4>
                We found some errors, be sure to enter the correct fields.
              </div>
  </c:if>
			<s:form role="form" modelAttribute="hotel" method="post"  enctype="multipart/form-data" action="${pageContext.request.contextPath}/user/superuser/create/hotel">
   ...
   <div class="box-footer">
                ...
                <button type="submit" class="btn btn-primary pull-right">Save Change </button> <input type="hidden" value="${user.id }" name="idac">
              </div>
			</s:form>
		</div>
	</div>
